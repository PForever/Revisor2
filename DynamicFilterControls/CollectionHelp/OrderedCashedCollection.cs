...
namespace DynamicFilterControls.CollectionHelp
{
    ...
    public class OrderedCashedCollection : List<object>, IBindingList
    {
        ...
        public object DefaultElement { get; set; }
        ...
        public OrderedCashedCollection(object value, int count, Action<Exception> onError = null) : base(Enumerable.Repeat(value, count))
        {
