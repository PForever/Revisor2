...
namespace Revisor2.Model.Infrastructure
{
    ...
    public class ViewModelCollection<T, TParent> : IHasParent<TParent>, IViewModelBase, INotifyCollectionChanged, IList<T>, IList
        where T : class, IViewModelBase
    {
        private Action<T, TParent> _parentSetter;
        public TParent Parent { get; set; }

        public ViewModelCollection(IEnumerable<T> src)
        {
        ...
        public ViewModelCollection(IEnumerable<T> src, TParent parent, Action<T, TParent> parentSetter)
        {
            Parent = parent;
